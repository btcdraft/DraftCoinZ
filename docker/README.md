...
official/supported Docker Images found at https://hub.docker.com/r/dftzpay/dftzd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/dftzpay/dftzd-develop/ when changing the above text**