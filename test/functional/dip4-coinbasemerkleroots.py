...
class LLMQCoinbaseCommitmentsTest(DFTzTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as DFTzTestFramework doesn't support this atm)
