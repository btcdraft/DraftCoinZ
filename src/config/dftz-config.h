/* src/config/dftz-config.h.  Generated from dftz-config.h.in by configure.  */
/* src/config/dftz-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The DFTz Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "DFTz Core"
...
#define PACKAGE_BUGREPORT "https://github.com/dftzpay/dftz/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DFTz Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DFTz Core 0.15.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dftzcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://dftz.org/"
