    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  dftz-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the DFTz in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 DFTZ, 0.01 DFTZ, 0.1 DFTZ, 1 DFTZ and 10 DFTZ -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.dftz.org/en/stable/wallets/dftzcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
