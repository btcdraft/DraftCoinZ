...
This mechanism has been integrated into Bitcore-Node-DFTz which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dftzpay/insight-api-dftz#web-socket-api](https://github.com/dftzpay/insight-api-dftz#web-socket-api)
* API: [https://github.com/dftzpay/insight-api-dftz#instantsend-transactions](https://github.com/dftzpay/insight-api-dftz#instantsend-transactions)
