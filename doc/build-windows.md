...
Below are some notes on how to build DFTz Core for Windows.
...
way. This will install to `c:\workspace\dftz`, for example:

    make install DESTDIR=/mnt/c/workspace/dftz
