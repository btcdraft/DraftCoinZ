# Linearize
Construct a linear, no-fork, best version of the DFTz blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install dftz_hash

https://github.com/dftzpay/dftz_hash
...
JSON-RPC server. Running `dftzd` or `dftz-qt -server` will be sufficient.
...
* `input`: dftzd blocks/ directory containing blkNNNNN.dat
